...
public class QuickSort {
	...
	public static void main(String[] args) {
		...
		int noOfElements;					// Declaring variable noOfElements that will represent size of itemArray
		...
		else
		{
			...
			QuickSort objOne=new QuickSort();							// objOne contains object of class LinearSearch
			 ...
			 **/
			itemArray=objOne.recQuickSort(itemArray, 0, noOfElements-1);
