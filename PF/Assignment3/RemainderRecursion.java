...
public class RemainderRecursion {
	...
	public static void main(String[] args)
	{
		...
		RemainderRecursion remainderRecursionObj = new RemainderRecursion();	
		int dividend , divisor , remainder;						
		System.out.println("Enter the dividend: ");				
		dividend = sc.nextInt();								
		System.out.println("Enter the divisor: ");				
		divisor = sc.nextInt();									
		remainder = remainderRecursionObj.rem(dividend , divisor);				// Method invocation and returning result to remainder variable
