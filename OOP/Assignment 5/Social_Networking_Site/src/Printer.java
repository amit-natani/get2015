...
public class Printer {
	...
	public static void searchDisplay(SocialNetwork socialNetworkObj, String name)
	{
		System.out.println();
		Set<Entity> entitySet = socialNetworkObj.searchByName(name);
		Iterator<Entity> itrEntity = entitySet.iterator();
		while(itrEntity.hasNext())
		{
			itrEntity.next().getRecords();
		}
		System.out.println();
	}
}
